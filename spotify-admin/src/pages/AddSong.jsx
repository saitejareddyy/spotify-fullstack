    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
      <div className='flex gap-8'>
        <div className='flex flex-col gap-4'>
          ...
          <label htmlFor="song">
            <img src={ song ? assets.upload_added : assets.upload_song } alt="song-logo" className='w-24 cursor-pointer' />
          </label>
        </div>
        <div className='flex flex-col gap-4'>
          <p>Upload Image</p>
          ...
          <label htmlFor="image">
            <img src={ image ? URL.createObjectURL(image) : assets.upload_area } alt="image-logo" className='w-24 cursor-pointer'/>
          </label>
        </div>
      </div>
      ...
      <div className='flex flex-col gap-2.5'>
        ...
        value={album} className='bg-transparent outline-green-600 border border-gray-400 p-2.5 w-[150px]'>
